...
func MatchesFilter(meta *pb.TableMeta, record *pb.Record, filters [][]string) bool {
	if len(filters) == 0 {
		return true
	}
...
func getFieldValue(meta *pb.TableMeta, record *pb.Record, fieldName string) (string, bool) {
